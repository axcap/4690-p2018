...
def main(unused_argv):
  ...
  fnist = input_data.read_data_sets(fnist_path)
...
>>>>>>> 968d29c916de6aa01f8830a1c873a695405f7094
  ...
  weights = mnist_classifier.get_variable_value('conv1/kernel')
  kernel = np.reshape(weights[:,:,:,0], (5,5))
  img = cv2.filter2D(img, -1, kernel)
  plt.imshow(np.reshape(img, (28,28)))
  plt.show()

  weights = mnist_classifier.get_variable_value('conv2/kernel')
  kernel = np.reshape(weights[:,:,0,0], (5,5))
  img = cv2.filter2D(img, -1, kernel)
  plt.imshow(np.reshape(img, (28,28)))
  plt.show()
