# src: https://github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/examples/tutorials/layers/cnn_mnist.py
...
def data_input():
    ...
    img_grey_1 = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
    img_grey = cv2.bitwise_not(img_grey_1)
    y,x = img_grey.shape
    #cv2.imshow("img_grey", img_grey);
    #cv2.waitKey(0)

    symbolHist = utils.find_symbol(img_grey)
