...
\begin{flushleft}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item{The data we want to test a classifier on needs to match the data we trained our classifier with. Hence we need to format our data to the same format as the datasets. \todo[inline]{Find steps and write a subsection on this} No need for a specific approach.}
    \end{itemize}
  \end{itemize}
\end{flushleft}
...
\begin{enumerate}
  \item Do threshold. \todo[inline]{Why do we do this? threshold the letters, for what reason?}
...
\todo[inline]{
edit the text above, has to be updated \\
. \\
. \\
. \\
. \\}
