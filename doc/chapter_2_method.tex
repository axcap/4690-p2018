...
\begin{flushleft}
  ...
  \begin{enumerate}
    ...
    270\textdegree], we run a rotation classifier on a subset of the characters
    from the text. Next the classifier classifies what state of rotation the
    text is in, and then we rotate the text accordingly.
  \end{enumerate}
\end{flushleft}
