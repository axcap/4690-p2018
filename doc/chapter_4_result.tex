...
\todo[inline]{result: Line segmentation}
...
\todo[inline]{Set result image on Result : Character segmentation} 
\subsection{Rotation}
\begin{figure}[H]
  \centering
  \missingfigure[figheight=6cm]{Result of character segmentation}
  % \includegraphics[height=4cm]{res/}
