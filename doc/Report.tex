...
\textbf{The purpose of the software is to recognize text from image, and
be able to do string manipulation on it. Hence this falls under the
...
\begin{itemize}
 \item{English alphabet [upper and lower case]+ numbers [0-9]}
...
We have come to the conclusion that the OCR software should have 3 main
components to it.
\begin{enumerate}
 ...
 \begin{itemize}
  ...
  etc.. (preprocessing from definition, should be done first, however because
  of simplification we assume we manage to segment out text first.)}
 \end{itemize}
