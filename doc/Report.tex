...
In this part of the program, we want to be able segment out parts of text in the image. We want to then late segment out lines and letter for further classification.
