...
\textbf{The purpose of our project \todo[inline]{software, (remove this?)} is to recognize text from image, and be able to do string manipulation on it. Hence this falls under the ``Optical character recognition'' (OCR) problem}
...
because of lighting, noise etc., therefore we take it for granted that we \todo[inline]{will
have to limit our software significantly. ----- byttes ut med: should limit our text recognition problem.}
...
\begin{enumerate}
 ...
 \begin{itemize}
  \item{Finding text \todo[inline]{segments} on an image and returning the text segments}
 \end{itemize}
