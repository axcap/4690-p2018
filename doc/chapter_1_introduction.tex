...
is organized. Chapter~\ref{M-sec:Method} is where we present methods we have
used in our final result. Discarded methods tried will be coverd in Chapter~\ref{D-sec:Discarded Method}.
In Chapter~\ref{R-sec:Result - Discussion} we review our approach and
its results, we present the confidence in our solution and what vulnerability
exist. In Chapter~\ref{C-sec:Conclusion} we present our thoughts on the project;
our ambition vs the actuall result, and potential future improvments on the
software. Chapter~\ref{6-sec:Recognition} includes refrance to third party
